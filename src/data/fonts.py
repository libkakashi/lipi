...
_SCRIPT_FONT_PATTERNS = {
    ...
    "devanagari": ["devanagari", "hindi", "marathi", "sanskrit", "mangal",
                   ...
                   "tirodevanagarihindi", "hind-", "muktavaani",
                   "baloodevanagari"],
    "gurmukhi": ["gurmukhi", "punjabi", "raavi", "muktamahee",
                 "baloo2", "baalopaaji", "tirogurmukhi"],
    "gujarati": ["gujarati", "shruti", "muktamalar",
                 "hindvadodara", "tirogujarati", "baloobahen"],
    "bengali": ["bengali", "bangla", "vrinda", "shonar",
                 "galada", "atma", "mina", "tirobangla",
                 "hindsiliguri", "balooda"],
    "odia": ["odia", "oriya", "kalinga", "baloobhaina"],
    "kannada": ["kannada", "tunga", "hindmysuru", "tirokannada",
                "balootamma"],
    "telugu": ["telugu", "gautami", "hindguntur", "tirotelugu",
               "mandali", "ramabhadra", "tenali", "gurajada", "lakki",
               "balootammudu"],
    "malayalam": ["malayalam", "kartika", "rachana",
                  "chilanka", "gayathri", "manjari", "hindkochi",
                  "baloochettan"],
    "tamil": ["tamil", "latha", "tirotamil", "hindmadurai",
